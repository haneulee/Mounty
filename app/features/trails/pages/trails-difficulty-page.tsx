...
export const meta: Route.MetaFunction = () => {
  return [
    { title: "Trails by Difficulty - Mounty" },
    { name: "description", content: "Find trails by difficulty level" },
  ];
};

export default function TrailsDifficultyPage({
  loaderData,
}: Route.ComponentProps) {
  return (
    <main className="container mx-auto px-4 py-8">
      <h1 className="text-4xl font-bold mb-8">Trails by Difficulty</h1>
